...
INSERT INTO Users
VALUES (N'Mihai Popescu', N'USER',N'Cluj-Napoca'), (N'Cristian Ionescu', N'ADMIN',N'Cluj-Napoca'), (N'Ana Marinescu', N'USER',N'Cluj-Napoca'), (N'Amy Jones', N'USER',N'Sydney'), (N'Matt Williams', N'ADMIN',N'Sydney');

INSERT INTO Devices
VALUES (N'Galaxy S25', N'Samsung', N'Phone', N'Android', N'15.0.6', N'Oryon V2 Phoenix', 12, NULL, N'Latest release of the most compact Galaxy phone'),
