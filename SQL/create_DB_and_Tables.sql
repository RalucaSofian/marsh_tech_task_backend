...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260408200652_InitialCreate'
)
BEGIN
...
BEGIN
    CREATE TABLE [Devices] (
        ...
        CONSTRAINT [FK_Devices_AspNetUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [AspNetUsers] ([Id])
    );
END;
...
BEGIN
    ...
    VALUES (N'20260408200652_InitialCreate', N'9.0.0');
END;
